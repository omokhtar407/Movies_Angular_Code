...
export class ContactComponent implements OnInit {
  ...
  countactForm:FormGroup = new FormGroup({
      ...
      subject:new FormControl(null,[Validators.required ,Validators.minLength(3),Validators.maxLength(15)]),
      message:new FormControl(null,[Validators.required ,Validators.minLength(3),Validators.maxLength(200)]),
  });
