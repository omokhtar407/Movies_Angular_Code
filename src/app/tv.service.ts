...
export class TvService {
  ...
  getTvCrew_Cast(tv_id:number):Observable<any>{
    return  this._HttpClient.get(`https://api.themoviedb.org/3/tv/${tv_id}/credits?api_key=c0d379e9b2fca29da7e3e39703976bc5&language=en-US`)
  }
}
